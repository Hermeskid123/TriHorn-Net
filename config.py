...
def get_args_parser():
    ...
    # Dataset
    parser.add_argument(
        "--model_name", default="hglass_2_1", type=str, help="hglass_numBlock_numStack"
    )
    ...
    parser.add_argument(
        ...
        choices=(1, 2, 3),
        type=int,
        help="which view to load samples from",
    )
    ...
    parser.add_argument(
        ...
        default=280,
        type=int,
        help="The size of the cubic around the hand",
    )

    parser.add_argument(
        "--cropSize", default=128, type=int, help="The size of input depth image"
    )
    ...
    parser.add_argument(
        ...
        default=32,
        type=int,
        help="the seed for generating a random subset of data",
    )
    ...
    parser.add_argument(
        ...
        default=-1,
        type=int,
        help="the size (in percentage) of the random subset of data (if -1, use the entire dataset)",
    )
    ...
    parser.add_argument(
        ...
        default=0,
        type=int,
        help="The number of joints that are randomly dropped for each frame",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        help="wether to use real or synthetic dataset",
    )
    ...
    parser.add_argument(
        ...
        default=1,
        type=int,
        help="The subject to be left out for Val/Test",
    )
    parser.add_argument(
        "--use_default_cube",
        default=1,
        type=int,
        help="Whether to use default 3D cubic size for each subject",
    )
    ...
    parser.add_argument(
        ...
        default=1,
        type=int,
        help="wether use refined COMs from a file",
    )

    parser.add_argument(
        "--RotAugment", default=1, type=int, help="wether to do rotation augmentation"
    )

    parser.add_argument(
        "--doAddWhiteNoise", default=0, type=int, help="wether to do noise augmentation"
    )
    ...
    parser.add_argument(
        ...
        default=1,
        type=float,
        help="standard deviation of noise augmentation",
    )
    ...
    parser.add_argument(
        ...
        default=8,
        type=float,
        help="the degree of adding random noise to COM",
    )
    ...
    parser.add_argument(
        ...
        default=0,
        type=float,
        help="an augmentation where it randomly zeros out a percentage of foreground pixels",
    )
    ...
    parser.add_argument(
        ...
        default=0,
        type=int,
        help="wether to apply random horizontal flip ",
    )
    ...
    parser.add_argument(
        ...
        default=1,
        type=int,
        help="use scale data augmentation from the range [0.8-1.2]",
    )
    ...
    parser.add_argument(
        ...
        choices=("DP", "DDP", "N"),
        type=str,
        help="DPP: DistributedDataParallel, DP: DataParallel, N: single-GPU",
    )
    ...
    parser.add_argument(
        ...
        default="0,1,2,3",
        type=str,
        help="the id of GPUs to use, e.g. 2,3,1",
    )
    ...
    parser.add_argument(
        "--ngpus_per_node", default="4", type=str, help="Num of GPUs that each Node has"
    )
    ...
    parser.add_argument(
        "--clip_max_norm", default=0, type=float, help="gradient clipping max norm"
    )
    ...
    parser.add_argument(
        ...
        default=1,
        type=int,
        help="whether to use tensorboard to log",
    )

    parser.add_argument(
        "--use_logger", default=1, type=int, help="whether to use logger"
    )
    ...
    parser.add_argument(
        ...
        default=10,
        type=int,
        help="the frequency with which checkpoints are made",
    )
    ...
    parser.add_argument(
        "--model_path",
        type=str,
        help="the address where the model is saved for resuming the training",
    )

    parser.add_argument(
        "--checkpoints_dir",
        type=str,
        help="where to save model chekpoints",
        required=True,
    )
    ...
    parser.add_argument(
        ...
        default="L1",
        choices=("L2", "L1", "huber"),
        help="The choice of the loss function",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="normal",
        choices=("normal", "aleatoric_hg", "aleatoric_resnet"),
        help="The choice of the loss function, NOTE: when using aleatoric, L2 lossFunc should be used",
    )

    parser.add_argument(
        "--joint_dim", default=3, type=int, help="wether to do 3D or 2D pose estimation"
    )

    parser.add_argument(
        "--decay_bias", default=1, type=int, help="whether to use decay on bias weights"
    )
    ...
    parser.add_argument(
        ...
        default="",
        type=str,
        help="whether or not to load .yaml config file to overwrite some args arguments",
    )
    ...
    parser.add_argument(
        ...
        default=0.9,
        type=float,
        help="the momentum used for SGD optimizer",
    )
    ...
    parser.add_argument(
        ...
        default=0,
        type=int,
        help="whether to use nesterov for SGD optimizer",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="cosine",
        choices=("steplr", "cosine", "cosineWarmap", "auto"),
        help="The choice for scheduler",
    )

    ##### for stepLR
    parser.add_argument(
        "--learning_rate_decay", default=1e-1, type=float, help="when steplr is used"
    )
    ...
    parser.add_argument(
        ...
        default=10,
        type=int,
        help="The learning rate will be multiplied by learning_rate_decay every decay_step epochs",
    )
    ...
    parser.add_argument(
        ...
        default=10,
        type=int,
        help="when cosine is used: the first number of epochs for restarting. if T0=num_epochs -> cosineAnnealing scheduler",
    )
    ...
    parser.add_argument(
        ...
        default=2,
        type=float,
        help="when cosine is used: after each restart, T is multiplied by Tmult",
    )
    ...
    parser.add_argument(
        ...
        default=0.0,
        type=float,
        help="when cosine is used: the minimum learning rate to reach",
    )
    ...
    parser.add_argument(
        ...
        default=0,
        type=int,
        help="whether to train the Temprature used in spatial softmax for the output heatmaps",
    )
